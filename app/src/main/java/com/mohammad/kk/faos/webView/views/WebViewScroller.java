...
public class WebViewScroller extends WebView implements NestedScrollingChild, NestedScrollingParent {

    private static final int INVALID_POINTER = -1;
    private static final String TAG = "WebViewScroller";
    ...
    public WebViewScroller(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.webViewStyle);
    }
    public WebViewScroller(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setDesktopMode(boolean enable){
        ...
        this.getSettings().setUseWideViewPort(enable);
        this.getSettings().setLoadWithOverviewMode(enable);
    }
}
